...
export function HomeSection() {
  return (
    <div className="flex flex-col lg:flex-row gap-8 w-full">
      {/* Hero Content */}
      <div className="flex-1 flex flex-col justify-center space-y-6 bg-secondary/90 backdrop-blur-sm border border-border/10 rounded-[24px] p-8 h-full shadow-lg">
